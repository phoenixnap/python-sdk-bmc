...
from pnap_ip_api import rest
from pnap_ip_api.configuration import Configuration
from pnap_ip_api.exceptions import ApiTypeError, ApiValueError, ApiException
from pnap_ip_api.version import VERSION
from pnap_ip_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = IPBlocksApi()
        api_instance.ip_blocks_get  # this is an instance of the class Endpoint
        api_instance.ip_blocks_get()  # this invokes api_instance.ip_blocks_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.ip_blocks_get.callable or self.callable in this class
