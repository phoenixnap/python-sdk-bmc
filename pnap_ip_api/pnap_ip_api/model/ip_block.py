...
class IpBlock(ModelNormal):
    ...
    def _from_openapi_data(cls, id, location, cidr_block_size, cidr, status, is_bring_your_own, created_on, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            assigned_resource_id (str): ID of the resource assigned to the IP Block.. [optional]  # noqa: E501
            assigned_resource_type (str): Type of the resource assigned to the IP Block.. [optional]  # noqa: E501
