...
class IpBlockCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, location, cidr_block_size, *args, **kwargs):  # noqa: E501
        """IpBlockCreate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, location, cidr_block_size, *args, **kwargs):  # noqa: E501
        """IpBlockCreate - a model defined in OpenAPI
