...
class TagAssignmentRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        """TagAssignmentRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            value (str): The value of the tag assigned to the resource. Tag values are case-sensitive, and should be composed of a maximum of 100 characters including UTF-8 Unicode letters, numbers, and the following symbols: '-', '_'. Regex: [A-zÀ-ú0-9_-]{1,100}.. [optional]  # noqa: E501
        """
