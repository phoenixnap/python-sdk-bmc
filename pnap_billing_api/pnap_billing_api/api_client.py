...
from pnap_billing_api.version import VERSION
...
import pnap_billing_api.models
from pnap_billing_api import rest
from pnap_billing_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pnap_billing_api.models, klass)
