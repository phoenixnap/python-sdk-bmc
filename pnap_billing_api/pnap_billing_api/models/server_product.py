...
class ServerProduct(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["productCode", "productCategory", "plans", "metadata"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": ServerProductMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None
        })
