...
class RatedUsageRecord(BaseModel):
    """
    Rated usage record.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "productCategory", "productCode", "location", "yearMonth", "startDateTime", "endDateTime", "cost", "costBeforeDiscount", "costDescription", "priceModel", "unitPrice", "unitPriceDescription", "quantity", "active", "usageSessionId", "correlationId", "reservationId", "discountDetails"]
