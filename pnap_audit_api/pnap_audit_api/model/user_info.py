...
class UserInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, username, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            client_id (str): The client ID of the application. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, username, *args, **kwargs):  # noqa: E501
        """UserInfo - a model defined in OpenAPI
