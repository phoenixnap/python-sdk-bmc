...
class Event(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, timestamp, user_info, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            name (str): The name of the event.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, timestamp, user_info, *args, **kwargs):  # noqa: E501
        """Event - a model defined in OpenAPI
