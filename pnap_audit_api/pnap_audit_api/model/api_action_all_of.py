...
class ApiActionAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, response, request, *args, **kwargs):  # noqa: E501
        """ApiActionAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, response, request, *args, **kwargs):  # noqa: E501
        """ApiActionAllOf - a model defined in OpenAPI
