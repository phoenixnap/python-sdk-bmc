...
from pnap_audit_api.exceptions import ApiTypeError, ApiValueError, ApiException
from pnap_audit_api.version import VERSION
from pnap_audit_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.events_get  # this is an instance of the class Endpoint
        api_instance.events_get()  # this invokes api_instance.events_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.events_get.callable or self.callable in this class
