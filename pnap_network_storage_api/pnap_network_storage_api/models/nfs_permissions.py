...
class NfsPermissions(BaseModel):
    """
    NFS specific permissions on a volume.
    """ # noqa: E501
    read_write: Optional[List[StrictStr]] = Field(default=None, description="Read/Write access.", alias="readWrite")
    read_only: Optional[List[StrictStr]] = Field(default=None, description="Read only access.", alias="readOnly")
