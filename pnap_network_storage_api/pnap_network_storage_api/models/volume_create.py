...
class VolumeCreate(BaseModel):
    ...
    Create Volume.
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="Volume friendly name.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "permissions": PermissionsCreate.from_dict(obj["permissions"]) if obj.get("permissions") is not None else None,
