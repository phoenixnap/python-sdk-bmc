...
class StorageNetworkCreate(BaseModel):
    """
    Create Storage Network.
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="Storage network friendly name.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "volumes": [StorageNetworkVolumeCreate.from_dict(_item) for _item in obj["volumes"]] if obj.get("volumes") is not None else None,
