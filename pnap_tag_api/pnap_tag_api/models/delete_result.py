...
class DeleteResult(BaseModel):
    ...
    """ # noqa: E501
    result: StrictStr = Field(description="Tag deletion result message.")
    tag_id: StrictStr = Field(description="The unique identifier of the tag.", alias="tagId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["result", "tagId"]
