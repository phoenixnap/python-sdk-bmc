...
from pnap_tag_api import rest
from pnap_tag_api.configuration import Configuration
from pnap_tag_api.exceptions import ApiTypeError, ApiValueError, ApiException
from pnap_tag_api.version import VERSION
from pnap_tag_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = TagsApi()
        api_instance.tags_get  # this is an instance of the class Endpoint
        api_instance.tags_get()  # this invokes api_instance.tags_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.tags_get.callable or self.callable in this class
