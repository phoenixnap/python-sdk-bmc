...
from pnap_rancher_solution_api.api_client import ApiClient, RequestSerialized
from pnap_rancher_solution_api.api_response import ApiResponse
from pnap_rancher_solution_api.rest import RESTResponseType
...
class ClustersApi:
    ...
    def clusters_id_delete(
        self,
        id: Annotated[StrictStr, Field(description="The Cluster identifier.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The Cluster identifier. (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
