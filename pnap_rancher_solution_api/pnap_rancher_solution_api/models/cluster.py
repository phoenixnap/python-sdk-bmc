...
class Cluster(BaseModel):
    ...
    location: StrictStr = Field(description="Deployment location. Cannot be changed once a cluster is created. Currently this field should be set to `PHX`, `ASH`, `SGP`, `NLD`, `CHI` or `SEA`.")
