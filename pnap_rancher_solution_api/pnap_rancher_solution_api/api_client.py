...
from pnap_rancher_solution_api.api_response import ApiResponse, T as ApiResponseT
import pnap_rancher_solution_api.models
from pnap_rancher_solution_api import rest
from pnap_rancher_solution_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = f"PNAP-python-sdk-bmc/pnap_rancher_solution_api/2.0.7.dev"
        self.client_side_validation = configuration.client_side_validation

         # Set default X-Powered-By.
        self.powered_by = f"PNAP-python-sdk-bmc/pnap_rancher_solution_api/2.0.7.dev"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pnap_rancher_solution_api.models, klass)
