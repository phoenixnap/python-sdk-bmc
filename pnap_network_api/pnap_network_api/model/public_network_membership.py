...
class PublicNetworkMembership(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, resource_id, resource_type, ips, *args, **kwargs):  # noqa: E501
        """PublicNetworkMembership - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, resource_id, resource_type, ips, *args, **kwargs):  # noqa: E501
        """PublicNetworkMembership - a model defined in OpenAPI
