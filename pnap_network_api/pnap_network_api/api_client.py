...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = PrivateNetworksApi()
        api_instance.private_networks_get  # this is an instance of the class Endpoint
        api_instance.private_networks_get()  # this invokes api_instance.private_networks_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.private_networks_get.callable or self.callable in this class
