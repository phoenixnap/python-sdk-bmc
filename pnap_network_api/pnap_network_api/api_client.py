...
from pnap_network_api.api_response import ApiResponse, T as ApiResponseT
import pnap_network_api.models
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = f"PNAP-python-sdk-bmc/pnap_network_api/3.0.2.dev"
        self.client_side_validation = configuration.client_side_validation

         # Set default X-Powered-By.
        self.powered_by = f"PNAP-python-sdk-bmc/pnap_network_api/3.0.2.dev"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pnap_network_api.models, klass)
