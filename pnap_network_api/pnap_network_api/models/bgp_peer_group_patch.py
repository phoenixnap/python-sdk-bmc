...
class BgpPeerGroupPatch(BaseModel):
    """
    Update a BGP Peer Group.
    """ # noqa: E501
    asn: Optional[StrictInt] = Field(default=None, description="The BGP Peer Group ASN.")
    ...
    advertised_routes: Optional[StrictStr] = Field(default=None, description="The Advertised routes for the BGP Peer Group. Can have one of the following values: `DEFAULT` and `NONE`.", alias="advertisedRoutes")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["asn", "password", "advertisedRoutes"]
