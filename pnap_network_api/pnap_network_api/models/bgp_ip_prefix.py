...
class BgpIpPrefix(BaseModel):
    """
    The BGP IP Prefix.
    """ # noqa: E501
    ip_allocation_id: StrictStr = Field(description="IP allocation ID.", alias="ipAllocationId")
    cidr: StrictStr = Field(description="The IP block in CIDR format, dependent on IP version.")
    ip_version: StrictStr = Field(description="The IP block version.", alias="ipVersion")
    status: StrictStr = Field(description="The BGP IP Prefix status. Can have one of the following values: `PENDING`, `BUSY`, `READY`, `ERROR` and `DELETING`.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["ipAllocationId", "cidr", "ipVersion", "status"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "ipAllocationId": obj.get("ipAllocationId"),
            "cidr": obj.get("cidr"),
