...
class AsnDetails(BaseModel):
    ...
    is_bring_your_own: StrictBool = Field(description="True if the BGP Peer Group ASN is a `bring your own` ASN.", alias="isBringYourOwn")
    verification_status: StrictStr = Field(description="The BGP Peer Group ASN verification status. Can have one of the following values: `PENDING_VERIFICATION`, `FAILED_VERIFICATION` and `VERIFIED`.", alias="verificationStatus")
    verification_reason: Optional[StrictStr] = Field(default=None, description="The BGP Peer Group ASN verification reason for the respective status.", alias="verificationReason")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["asn", "isBringYourOwn", "verificationStatus", "verificationReason"]
