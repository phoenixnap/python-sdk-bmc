...
from pnap_location_api import rest
from pnap_location_api.configuration import Configuration
from pnap_location_api.exceptions import ApiTypeError, ApiValueError, ApiException
from pnap_location_api.version import VERSION
from pnap_location_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_locations  # this is an instance of the class Endpoint
        api_instance.get_locations()  # this invokes api_instance.get_locations.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_locations.callable or self.callable in this class
