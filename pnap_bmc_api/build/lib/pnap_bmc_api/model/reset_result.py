...
def lazy_import():
    ...
    globals()['OsConfigurationMap'] = OsConfigurationMap


class ResetResult(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'os_configuration': (OsConfigurationMap,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, result, *args, **kwargs):  # noqa: E501
        """ResetResult - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            password (str): Password set for user Admin on Windows server or user root on ESXi server.. [optional]  # noqa: E501
            os_configuration (OsConfigurationMap): [optional]  # noqa: E501
        """
