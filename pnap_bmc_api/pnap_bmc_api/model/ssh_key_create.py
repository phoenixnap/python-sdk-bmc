...
class SshKeyCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, default, name, key, *args, **kwargs):  # noqa: E501
        """SshKeyCreate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, default, name, key, *args, **kwargs):  # noqa: E501
        """SshKeyCreate - a model defined in OpenAPI
