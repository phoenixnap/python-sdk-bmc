...
class OsConfigurationWindows(ModelNormal):
    ...
    attribute_map = {
        'rdp_allowed_ips': 'rdpAllowedIps',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OsConfigurationWindows - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            rdp_allowed_ips ([str]): List of IPs allowed for RDP access to Windows OS. Supported in single IP, CIDR and range format. When undefined, RDP is disabled. To allow RDP access from any IP use 0.0.0.0/0. This will only be returned in response to provisioning a server.. [optional]  # noqa: E501
        """
