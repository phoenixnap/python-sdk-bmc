...
class StorageConfigurationRootPartition(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StorageConfigurationRootPartition - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            raid (str): Software RAID configuration. The following RAID options are available: NO_RAID, RAID_0, RAID_1.. [optional] if omitted the server will use the default value of "NO_RAID"  # noqa: E501
            size (int): The size of the root partition in GB. -1 to use all available space.. [optional] if omitted the server will use the default value of -1  # noqa: E501
        """
