...
class SshKey(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, default, name, key, fingerprint, created_on, last_updated_on, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, default, name, key, fingerprint, created_on, last_updated_on, *args, **kwargs):  # noqa: E501
        """SshKey - a model defined in OpenAPI
