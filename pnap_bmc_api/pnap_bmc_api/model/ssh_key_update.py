...
class SshKeyUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, default, name, *args, **kwargs):  # noqa: E501
        """SshKeyUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, default, name, *args, **kwargs):  # noqa: E501
        """SshKeyUpdate - a model defined in OpenAPI
