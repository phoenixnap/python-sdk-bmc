...
class ServerProvision(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, hostname, os, *args, **kwargs):  # noqa: E501
        """ServerProvision - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, hostname, os, *args, **kwargs):  # noqa: E501
        """ServerProvision - a model defined in OpenAPI
