...
class OsConfigurationMapEsxi(BaseModel):
    """
    VMWare ESXi configuration properties.
    """ # noqa: E501
    root_password: Optional[StrictStr] = Field(default=None, description="(Read-only) Password set for user root on an ESXi server which will only be returned in response to provisioning a server.", alias="rootPassword")
