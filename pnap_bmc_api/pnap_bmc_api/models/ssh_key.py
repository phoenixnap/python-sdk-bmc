...
class SshKey(BaseModel):
    ...
    SSH Key.
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier of the SSH Key.")
    ...
    name: StrictStr = Field(description="Friendly SSH key name to represent an SSH key.")
    key: StrictStr = Field(description="SSH Key value.")
