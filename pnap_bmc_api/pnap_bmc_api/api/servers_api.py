...
class ServersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.servers_server_id_actions_provision_post_endpoint = _Endpoint(
            settings={
                'response_type': (Server,),
                'auth': [
                    'OAuth2'
                ],
                'endpoint_path': '/servers/{serverId}/actions/provision',
                'operation_id': 'servers_server_id_actions_provision_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def servers_server_id_actions_provision_post(
        ...
        **kwargs
        ...
        """Provision server.  # noqa: E501

        Provision reserved server. Server DNS will be configured to access Google's public DNS at 8.8.8.8.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.servers_server_id_actions_provision_post(server_id, server_provision, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['server_id'] = \
            server_id
        kwargs['server_provision'] = \
            server_provision
        return self.servers_server_id_actions_provision_post_endpoint.call_with_http_info(**kwargs)
